...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO jadwal_pendaftaran (agenda,periode_mulai,periode_akhir) VALUES ('$agenda','$periode_mulai','$periode_akhir')";
          ...
          <form action="" method="POST">
            ...
            <label>Agenda</label>
             <div class="form-floating mb-3">
                 <input type="text" class="form-control" name="agenda" required id="agenda" autocomplete="off">
             </div>
           ...
           <label>Periode Akhir</label>
            <div class="form-floating mb-3">
               <input type="date" class="form-control" name="periode_akhir" id="tgl_diterima" required>
           </div>
            <br> 
  ...
  <div class="table-responsive">
    <table id="tabelsm" class="table table-striped" style="width:100%; text-align: center;">
            ...
            <tbody>
                ...
                $sql = "SELECT id_jadwal,agenda, periode_mulai, periode_akhir from jadwal_pendaftaran";
                ...
                if ($result-> num_rows > 0) {
                    ...
                    <tr>
                      ...
                      <td> 
                        <a href="edit_jadwal.php?id_jadwal=<?= $row['id_jadwal'];?>" class="btn btn-warning btn-sm" id="editdata" data-bs-toggle="modal" data-bs-target="#edit"><i class="fas fa-edit"></i></a>
                        <a href="delete_jadwal.php?id_jadwal=<?= $row['id_jadwal'];?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                      </td>
