  ...
  <div class="container">
    ...
    <table id="tabelsm" class="table table-striped" style="width:100%; text-align: center;">
            ...
            <tbody>
                ...
                $sql = "SELECT dokumen.id_dokumen, dokumen.nisn, dokumen.dokumen, cama.nama from dokumen join cama where dokumen.nisn=cama.nisn";
                ...
                <?php if ($result-> num_rows > 0) : ?>
                  ...
                  <?php while ($row = $result-> fetch_assoc()) : ?>
                    <tr>
                      ...
                      <td>
                        <button type="button" id="btnshow" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#showdoc">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <div class="embed-responsive embed-responsive-16by9">
                              <iframe class="embed-responsive-item" src="doc/<?= $row['dokumen'] ; ?>"></iframe>
                            </div>
                          </div>
                        </div>
                      </div>
